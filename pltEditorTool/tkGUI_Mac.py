...
def __create_widgets(window):
    ...
    window.data_select['pady'] = '10'
    window.data_select['padx'] = '10'
    ...
    window.label = tk.Label(window.data_sel_frame, text='Multiple:',
                          font=('New York', '12', 'bold'))
    ...
    window.data_labels_frame = tk.Frame(window.plotsFrame)
    window.data_labels_frame.grid(row=0, column=1)

    # Input EntryBox for Data Label
    window.label = tk.Label(window.data_labels_frame, text='Data Label:',                      font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.data_labels_frame, text='Fill Label:',                      font=('New York', '12', 'bold'))
    ...
    #************************************************************#
    #************************************************************#
    window.plot_options_frame = tk.Frame(window.plotsFrame)
    ...
    window.label = tk.Label(window.ebar_dat, text='Error Bar?:',                               font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.ebar_dat, text='Color:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=1, column=0, padx=5, pady=2)
    if PLATFORM == "Darwin":
        window.eb_col = tk.Button(window.ebar_dat, text='COLOR',
                            fg=window.ebar_color.get(),
                            font=('New York', '12', 'bold'),
    ...
    # Errorbar linewidth
    window.label = tk.Label(window.ebar_dat, text='Width:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.ebar_dat, text='Error Bar Cap:',
                          font=('New York', '12', 'underline'))
    window.label.grid(row=3, column=0, columnspan=2, padx=5, pady=2)

    # Errorbar Cap Size
    window.label = tk.Label(window.ebar_dat, text='Size:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.ebar_dat, text='Thickness:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.line_dat, text='Line?:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=0, column=0, padx=5, pady=2)
    ...
    window.label = tk.Label(window.line_dat, text='Color:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=1, column=0, padx=5, pady=2)
    if PLATFORM == "Darwin":
        window.l_col = tk.Button(window.line_dat, text='COLOR',
                            fg=window.line_color.get(),
                            font=('New York', '12', 'bold'),
    ...
    window.label = tk.Label(window.line_dat, text='Style:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=2, column=0, padx=5, pady=2)
    ...
    window.l_sty['pady'] = '10'
    window.l_sty['padx'] = '10'
    ...
    window.label = tk.Label(window.line_dat, text='Width:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.line_dat, text='Alpha:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.marker_dat, text='Marker?:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=0, column=0, padx=5, pady=2)
    ...
    window.label = tk.Label(window.marker_dat, text='Type:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=1, column=0)
    ...
    window.m_type['pady'] = '10'
    window.m_type['padx'] = '10'
    ...
    window.label = tk.Label(window.marker_dat, text='Edge Color:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=2, column=0)
    if PLATFORM == "Darwin":
        window.m_ecol = tk.Button(window.marker_dat, text='COLOR',
                            fg=window.mark_ec.get(),
                            font=('New York', '12', 'bold'),
    ...
    window.label = tk.Label(window.marker_dat, text='Edge Width:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.marker_dat, text='Face Color:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=4, column=0)
    if PLATFORM == "Darwin":
        window.m_fcol = tk.Button(window.marker_dat, text='COLOR',
                                fg=window.mark_fc.get(),
                                font=('New York', '12', 'bold'),
    ...
    window.label = tk.Label(window.marker_dat, text='Size:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.marker_dat, text='Mark Every:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.fill_dat, text='Fill?:',
                          font=('New York', '12', 'bold'))
    ...
    window.label = tk.Label(window.fill_dat, text='Alpha:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=1, column=0)
    ...
    window.label = tk.Label(window.fill_dat, text='Face Color:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=2, column=0)
    ...
    window.label = tk.Label(window.fill_dat, text='Edge Color:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=3, column=0)
    
    window.f_ecol = tk.Button(window.fill_dat, text='COLOR', fg=window.fill_ec.get(),
    ...
    window.label = tk.Label(window.fill_dat, text='Edge Width:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=4, column=0)
    ...
    window.label = tk.Label(window.fill_dat, text='Edge Style:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=5, column=0)
    ...
    window.scatter_dat.grid(row=0, column=8, columnspan=2, padx=0)
    window.scatter_dat.grid_propagate(0)
    window.label = tk.Label(window.scatter_dat, text='Scatter?:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=0, column=0)
    window.scat_exist_check = tk.Checkbutton(window.scatter_dat,
                                           variable=window.scat_exist,
                                           command=window.scatter_select)
    window.scat_exist_check.grid(row=0, column=1, padx=0, pady=0)

    window.label = tk.Label(window.scatter_dat, text='Marker:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=1, column=0)
    ...
    window.scatter_type['pady'] = '10'
    window.scatter_type['padx'] = '10'
    window.scatter_type['relief'] = tk.RAISED
    window.scatter_type['anchor'] = tk.W
    window.scatter_type['highlightthickness'] = '0'
    window.scatter_type.grid(row=1, column=1, padx=0, pady=0)
    ...
    window.scatter_edge['pady'] = '10'
    window.scatter_edge['padx'] = '10'
    window.scatter_edge['relief'] = tk.RAISED
    window.scatter_edge['anchor'] = tk.W
    window.scatter_edge['highlightthickness'] = '0'
    window.scatter_edge.grid(row=1, column=2, padx=0, pady=0)

    window.label = tk.Label(window.scatter_dat, text='Alpha:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=2, column=0)

    window.scat_alpha_choice = tk.Spinbox(window.scatter_dat, textvariable=window.scat_alpha,
                                 width='4', from_=0, to=1, increment=0.01)
    window.scat_alpha_choice.grid(row=2, column=1, padx=0, pady=0)

    window.label = tk.Label(window.scatter_dat, text='Color:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=3, column=0)
    ...
    window.scatter_color['pady'] = '10'
    window.scatter_color['padx'] = '10'
    window.scatter_color['relief'] = tk.RAISED
    window.scatter_color['anchor'] = tk.W
    window.scatter_color['highlightthickness'] = '0'
    window.scatter_color.grid(row=3, column=1, columnspan=2, padx=0, pady=0)

    window.label = tk.Label(window.scatter_dat, text='Size:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=4, column=0)
    ...
    window.scatter_size['pady'] = '10'
    window.scatter_size['padx'] = '10'
    window.scatter_size['relief'] = tk.RAISED
    window.scatter_size['anchor'] = tk.W
    window.scatter_size['highlightthickness'] = '0'
    window.scatter_size.grid(row=4, column=1, columnspan=2, padx=0, pady=0)

    window.label = tk.Label(window.scatter_dat, text='Color Bar?:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=5, column=0)
    window.cb_exist_check = tk.Checkbutton(window.scatter_dat,
                                         variable=window.cb_exist)
    window.cb_exist_check.grid(row=5, column=1, padx=0, pady=0)

    window.label = tk.Label(window.scatter_dat, text='Color Map:',
                          font=('New York', '12', 'bold'))
    window.label.grid(row=6, column=0)
    ...
    window.color_map['pady'] = '10'
    window.color_map['padx'] = '10'
    window.color_map['relief'] = tk.RAISED
    window.color_map['anchor'] = tk.W
    window.color_map['highlightthickness'] = '0'
    window.color_map.grid(row=6, column=1, columnspan=2, padx=0, pady=0)
    ...
    window.addnewAxis['fg'] = BG_GREEN
    window.addnewAxis['padx'] = '5'
    window.addnewAxis['pady'] = '5'
    ...
    window.axis_select['pady'] = '10'
    window.axis_select['padx'] = '10'
    ...
    window.delAxis['fg'] = BG_RED
    window.delAxis['padx'] = '5'
    window.delAxis['pady'] = '5'
    ...
    window.label = tk.Label(window.selDataFrame, text='All Data',
                          font=('New York', '12', 'bold'))
    ...
    window.alldat['pady'] = '10'
    window.alldat['padx'] = '10'
    ...
    window.add_dat = tk.Button(window.selDataFrame, text='>', font=('New York', '14', 'bold'),
                             command=window.add_plot_to_axis)
    window.add_dat['fg'] = BG_GREEN
    window.add_dat['padx'] = '5'
    window.add_dat['pady'] = '5'
    window.add_dat.grid(row=1, column=1)

    window.rem_dat = tk.Button(window.selDataFrame, text='<', font=('New York', '14', 'bold'),
                             command=window.remove_plot_from_axis)
    window.rem_dat['fg'] = BG_RED
    window.rem_dat['padx'] = '5'
    window.rem_dat['pady'] = '5'
    ...
    window.seldat['pady'] = '10'
    window.seldat['padx'] = '10'
    ...
    window.leg_pos['pady'] = '10'
    window.leg_pos['padx'] = '10'
    ...
    window.show_plot['fg'] = '#076707'
    window.show_plot['font'] = ('New York','16','bold')
    ...
    window.save_plot_btn['fg'] = '#800080'
    window.save_plot_btn['font'] = ('New York','16','bold')
