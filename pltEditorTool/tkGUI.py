...
def __create_widgets(window):
    ...
    window.addnewAxis.grid(row=0, column=0, sticky=tk.W+tk.E, padx=5, pady=5)
    ...
    window.delAxis.grid(row=0, column=2, sticky=tk.W+tk.E, padx=8, pady=6)
    ...
    window.alldat.grid(row=1, column=0, padx=5)
    ...
    window.seldat.grid(row=1, column=2, padx=5)
    ...
    window.axlabFrame = tk.LabelFrame(window.axisFrame, text='Axis Labels',
                                    ...
                                    font=('Courier New', '12', 'bold'))
    window.axlabFrame.grid(row=1, column=0, columnspan=4, rowspan=3, padx=5,
    ...
    window.xlimloEntry = tk.Entry(window.axlabFrame, textvariable=window.xlimlow,
                                width='5')
    window.xlimloEntry.grid(row=1, column=1, padx=2, pady=1)
    ...
    window.xlimhiEntry = tk.Entry(window.axlabFrame, textvariable=window.xlimhi,
                                width='5')
    window.xlimhiEntry.grid(row=1, column=3, padx=2, pady=1)
