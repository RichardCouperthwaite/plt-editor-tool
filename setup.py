...
setup(
  ...
  description = 'This package provides a GUI editing matplotlib plots',   # Give a short description about your library
  ...
  download_url = 'https://github.com/RichardCouperthwaite/plt-editor-tool/archive/1.1.0.tar.gz',    # I explain this later on
