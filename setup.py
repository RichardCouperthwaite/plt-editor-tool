...
setup(
  ...
  version = '1.1.1-2',    # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/RichardCouperthwaite/plt-editor-tool/archive/1.1.1.tar.gz',    # I explain this later on
