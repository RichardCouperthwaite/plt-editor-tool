...
setup(
  ...
  version = '1.0.13',    # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/RichardCouperthwaite/plt-editor-tool/archive/1.0.13.tar.gz',    # I explain this later on
