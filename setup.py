...
setup(
  ...
  description = 'This package provides a GUI based approach for setting up and editing matplotlib plots. Please see the Github repository for more detailed information on how to use the package',   # Give a short description about your library
  ...
  download_url = 'https://github.com/RichardCouperthwaite/plt-editor-tool/archive/1.0.15.tar.gz',    # I explain this later on
